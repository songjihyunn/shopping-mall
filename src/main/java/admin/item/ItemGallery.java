...
@WebServlet("/admin/item/gall")
public class ItemGallery extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		//한 페이지 보여질 글의 갯수
				int pageSize = 10;
				...
				String category1 = request.getParameter("");
				//검색어
