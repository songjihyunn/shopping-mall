...
<center>
<div class="table-container" style="width: 1600px; height: 900px; position: relative; background: white; display: flex; justify-content: center;">
  ...
  <form  action="write"  method="post"  onsubmit="return validateForm();" enctype="multipart/form-data">
    <div class="PostComments" style="width: 720px; height: 508px; top:60px; flex-direction: column; justify-content: flex-start; align-items: center; gap: 20px; display: inline-flex; border: 1px solid gray">
      <div class="AskBlock" style="height: 508px;  padding-left: 40px; padding-right: 40px; padding-top: 100px; padding-bottom: 30px; background: white; box-shadow: 2px 1px 5px rgba(0, 0, 0, 0.15); flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 20px; display: flex; border: 1px solid gray">
        <div class="Frame4" style="width: 640px; height: 34px; position: relative; border-radius: 5px; border: 2px #EAEAEA solid">
          <input id="subject" name="subject" class="Frame5" placeholder="제목을 입력하세요." style="width: 640px; height: 34px; position: relative; border-radius: 5px; border: 2px #EAEAEA solid">
        ...
        <div class="Frame5" style="width: 640px; height: 344px; position: relative; border-radius: 5px; border: 2px #EAEAEA solid">
          <textarea id="comment" name="comment" placeholder="내용을 입력하세요." required style="width: 640px; height: 344px; position: relative; border-radius: 5px; border: 2px #EAEAEA solid"></textarea>
