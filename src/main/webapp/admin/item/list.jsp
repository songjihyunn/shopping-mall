...
<table border="0" style="width: 900px;">
	<tr>
		<td align=center style="height: 150px; color:#777;font-size:14px;font-weight:bold; font-size:20px">물품관리</td>
	</tr>
	<tr height="800px">
		<td height="100px" width="1800px">	<!-- 상품검색 -->
				  ...
				  <div style="margin-top: -280px;">
					  <table class="custom" border="0" >
						<tr height="50px" width="900" style="text-align:center; border-bottom: 1px solid black; background-color: #1A1919;" bgcolor="#e5ecef">
				              ...
				              <td class="td_title" style="color: #ffffff">가격(세일)</td>
						...
						<c:forEach var="i" items="${v }">
			              <form action="list" method="post" enctype="multipart/form-data">
							...
							<tr height=24>
								...
								<td align="center"><fmt:formatNumber value="${i.it_price}" pattern="#,###원"/><br>(<fmt:formatNumber value="${i.it_sale}" pattern="#,###원"/>)</td>
								<td align="center">${i.it_use}</td>
								<td width=130 align="center">
									<input type="button" value="보기" class="buy_btn" onclick="location.href='ItemView?it_uid=${i.it_uid}&pageNum=${pageNum}&field=${field}&search=${search}'">
									<input type="button" value="수정" class="buy_btn" onclick="location.href='ItemModify?it_uid=${i.it_uid}&pageNum=${pageNum}&field=${field}&search=${search}'">
									<input type="button" value="삭제" class="buy_btn" onclick="location.href='ItemDelete?it_uid=${i.it_uid}'">
								</td>
							</tr>
            ...
            <table width=100% border=0 align="center">  <!-- style="margin-left:-200px" -->
              <tr height="30px">
              	<td colspan="3" align="right" style="margin-left: -300px">
              		<a href="write">
					  <button class="custom-write">물품 등록</button>
					</a>
				</td>
			 </tr>	
              <tr>
