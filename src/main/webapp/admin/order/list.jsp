				  ...
				  <div class="table-container" style="margin-top: -280px;">
					  <table class="custom" border="0" >
						<tr height="50px" width="900" style="text-align:center; border-bottom: 1px solid black; background-color: #1A1919;" bgcolor="#e5ecef">
							...
							<td class="td_title" style="color: #ffffff">Mode</td>
						</tr>
								...
								<c:if test="${not empty o}">
								    ...
								    <c:forEach var="order" items="${o}">
								        ...
								        <tr height="81" class="custom_bottom">
											...
											<td align="center">
												<input type="button" value="상세" class="buy_btn" onclick="popup('${order.mb_id }')" style="cursor:pointer">
								            	<input type="button" value="수정" class="buy_btn" onclick="popup_modify('${order.mb_id }')" style="cursor:pointer">
								            	<input type="button" value="삭제" class="buy_btn" onclick="od_delete('${order.od_uid }')" style="cursor:pointer">
								            </td>
								        </tr>
								    </c:forEach>
									</c:if>
