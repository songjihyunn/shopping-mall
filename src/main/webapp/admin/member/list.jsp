...
<div class="table-container" style="width: 1800px; height: 1000px; position: absolute; background: white">
<table border="0" style="width: 900px;">
	<tr>
		<td align=center style="height: 150px; color:#777;font-size:14px;font-weight:bold; font-size:20px">회원관리</td>
	</tr>
	<tr height="800px">
				...
				<form>
				 ...
				 <%--  <div style="width: 900px; height: 42px; left: 490px; top: 200px; position: absolute">
				  ...
				  <div style="margin-top: -200px;">
					  <table class="custom" border="0" width="1200">
						<tr height="50px" width="900" style="text-align:center; border-bottom: 1px solid black; background-color: #1A1919;" bgcolor="#e5ecef">
							...
							<td class="td_title" style="color: #ffffff">나이</td>
							<td class="td_title" style="color: #ffffff">성별</td>
							<td class="td_title" style="color: #ffffff">메일주소</td>
							<td class="td_title" style="color: #ffffff">레벨</td>
							<td class="td_title" style="color: #ffffff">상태</td>
							<td class="td_title" style="color: #ffffff">가입날짜</td>
							<td class="td_title" style="color: #ffffff" width="500">Mode</td>
						</tr>
						...
						<tr height="24">
							...
							<td align="center">
								<c:if test="${list.status ne '정상'}"><font color=red></c:if>
									${list.status }
								<c:if test="${list.status ne '정상'}"></font></c:if>
							</td>
							<td align="center">${list.signdate }</td>
							<td align="center">
								<button class="custom-button" onclick="popup('${list.id }')" style="cursor:pointer">상세</button>
								<button class="custom-button" onclick="popup_modify('${list.id }')" style="cursor:pointer">수정</button>
								<button class="custom-button" onclick="id_delete('${list.id }')" style="cursor:pointer">삭제</button>
							</td>
						</tr>
						<tr><td colspan=10 height=1 bgcolor="#e5ecef"></td></tr>
						<c:set var="number" value="${number - 1 }" />
						</c:forEach>
					</table>
				</div>
			<div width=1000 height="30" style="" ></div>
            <table width=1500 border=0 align="center" style="margin: 30px; margin-left: 30px">
              <tr height="30px">
              	<td colspan="3" align="right">
              		<button class="custom-write" onclick="write" style="cursor:pointer">회원추가</button>
				</td>
			</tr>	
              <tr>
                <td width=30%></td>
