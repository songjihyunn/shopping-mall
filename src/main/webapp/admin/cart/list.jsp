				...
				<form method="get">
				  <div style="width: 372px; height: 100px; left: 500px; top: 150px; position: absolute">
				  	<select name="field" style=" width: 80px; height: 40px;">
				  		<option value="it_name" <c:if test="${field == 'mb_id' }">selected</c:if>>상품명</option>
					</select>
					  ...
					  <table class="custom" border="0" >
						...
						<c:forEach var="i" items="${v }">
							...
							<tr height="50">
								...
								<td align="center">${i.it_size }</td>								<td align="center">
								...
								<td align="center"><input type="button" value="삭제하기" class="buy_btn" onclick="location.href='/admin/cart/delete?ct_uid=${i.ct_uid }'"></td>
								<td align="center"><input type="button" value="구매하기" class="buy_btn" onclick="location.href='/admin/cart/view?ct_uid=${i.ct_uid }'"></td>
							</tr>
